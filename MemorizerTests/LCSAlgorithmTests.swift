...
struct LCSAlgorithmTests {
    ...
    func emptyLeftArrayReturnsEmptyResult() {
        let result = lcs.lcsMatches([], ["hello", "bob"], matches: ==)
    ...
    func singleMatchingElementReturnsMatchingIndex() {
        let result = lcs.lcsMatches(["hello"], ["hello"], matches: ==)
    ...
    @Test("Matching arrays return matching indices")
    func matchingArraysReturnMatchingIndices() {
        let result = lcs.lcsMatches(["hello", "bob"], ["hello", "bob"], matches: ==)
    ...
    func arraysWithNoCommonElementsReturnEmptyResult() {
        let result = lcs.lcsMatches(["a", "b"], ["c", "d"], matches: ==)
        #expect(result.isEmpty)
    }
